"""Compare Q-learning discount factors across several seeds."""
...
def run_gamma_experiments(
    ...
    """Train and evaluate every gamma and seed combination."""
...
def main() -> None:
    """Run the gamma comparison and save the results."""
    ...
    summary = results.groupby("gamma").agg(
    ...
    print("Q-learning gamma comparison")
    print("---------------------------")
